...
class ContentClassifier:
    def __init__(self):
        ...
        # We must use alternate_sign=False because MultinomialNB requires non-negative input
        self.vectorizer = HashingVectorizer(
            alternate_sign=False, n_features=2**10, analyzer='char_wb', ngram_range=(2, 4)
        )
    ...
    def train_baseline(self):
        ...
        # partial_fit requires the list of possible classes at the first call
